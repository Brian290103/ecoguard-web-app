...
const ReportsPage = async () => {
  ...
  return (
    <>
      <SiteHeaderSetter title="Authority: Reports" />
      <div className="flex flex-col gap-3">
        <Card>
          <CardHeader>
            <CardTitle>Geo-Located Environmental Reports</CardTitle>
            <CardDescription>
              Access and manage environmental incident reports from your
              assigned geographical area. Monitor local environmental issues and
              track report statuses based on location data.
            </CardDescription>
